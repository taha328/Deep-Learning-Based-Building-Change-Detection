    ...
    () => ({
      t1Preview:
        workflowMode === "pairwise" && result?.preview_images?.t1_preview_path
          ? buildGradioFileUrl(backendUrl, result.preview_images.t1_preview_path)
          : null,
      t2Preview:
        workflowMode === "pairwise" && result?.preview_images?.t2_preview_path
          ? buildGradioFileUrl(backendUrl, result.preview_images.t2_preview_path)
          : null,
      temporalReferenceImagery:
      ...
      changeProbability:
        workflowMode === "pairwise" && result?.preview_images?.change_probability_preview_path
          ? buildGradioFileUrl(backendUrl, result.preview_images.change_probability_preview_path)
          : null,
      changeOverlay:
        workflowMode === "pairwise" && result?.preview_images?.change_overlay_preview_path
          ? buildGradioFileUrl(backendUrl, result.preview_images.change_overlay_preview_path)
          : null,
    }),
