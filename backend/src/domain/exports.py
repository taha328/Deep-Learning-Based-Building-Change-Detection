    ...
    *,
    ...
    artifacts = [
        ...
        ArtifactEntry(
            ...
            description="Local change score preview",
        ),
        ArtifactEntry(
        ...
        ArtifactEntry(
            ...
            description="Local change score raster",
        ),
        ArtifactEntry(
    ...
    *,
    ...
    artifacts = [
        ...
        ArtifactEntry(
            ...
            media_type="image/png",
            description="Segmentation score preview",
        ),
        ArtifactEntry(
            name="segmentation_overlay_preview_png",
            path=str(overlay_preview_path),
            media_type="image/png",
            description="Segmentation overlay preview",
        ),
        ...
        ArtifactEntry(
            ...
            media_type="image/tiff",
            description="Segmentation probability raster",
        ),
        ArtifactEntry(name="segmentation_mask_tif", path=str(mask_raster), media_type="image/tiff", description="Segmentation mask raster"),
        ArtifactEntry(
