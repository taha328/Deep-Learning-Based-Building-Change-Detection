    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-5">
          ...
          {error ? (
            <div role="alert" className="rounded border border-red-300 bg-red-50 px-4 py-3 text-sm text-red-950 dark:border-red-500/40 dark:bg-red-950/30 dark:text-red-100">
              {error}
            </div>
          ) : null}
        </div>
